...
\sjtusetup{
  ...
  info = {%
    ...
    title*          = {Research on the pulmonary bronchial segmentation technique in lung CT images},
    %
    % 标题页标题
    %   可使用“\\”命令手动控制换行
    %
    ...
    % 关键词
    %
    keywords        = {支气管气道树分割, 3D-UNet基准网络, 注意力蒸馏, 通道级特征再学习, ATM22数据集},
    keywords*       = {Bronchial airway segmentation, 3D-UNet baseline network, Attention distillation, Channel-wise feature re-learning, ATM22 dataset},
    %
    % 姓名
    %
    author          = {徐\quad{}赞},
    ...
    % 副指导教师
    %
    assisupervisor  = {刘维平副教授},
    assisupervisor* = {Prof. Liu Wei Ping},
    %
    % 学号
    %
    id              = {116033210067},
