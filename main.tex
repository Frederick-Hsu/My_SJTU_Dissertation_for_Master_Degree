...
\input{contents/baseline_unet3d}
\input{contents/attention_distillation}
\input{contents/feature_recalibration}
\input{contents/summary_and_outlook}
...
% 附录内容
\input{contents/experiment_source_code}
